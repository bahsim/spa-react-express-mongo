...
var TasksRecordEditCauseExtraInfo = createReactClass({
	isThisCause() {
...
const mapStateToProps = (state, ownProps) => ({
	cause: 	state.tasksFormEdit.cause,
	record:	state.tasksFormEdit.extraInfo
})
...
export default connect(mapStateToProps, mapDispatchToProps)(TasksRecordEditCauseExtraInfo);
